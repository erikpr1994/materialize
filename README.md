...
- **[`ask-author`](./skills/engineering/ask-author/SKILL.md)** *(user-invoked)* — ask which skill or flow fits your situation; a router over the user-invoked skills here.
...
- **[`git-guardrails-claude-code`](./skills/misc/git-guardrails-claude-code/SKILL.md)** — keep git history clean and safe.
- **[`migrate-to-shoehorn`](./skills/misc/migrate-to-shoehorn/SKILL.md)** — migrate a project to shoehorn.
- **[`scaffold-exercises`](./skills/misc/scaffold-exercises/SKILL.md)** — scaffold practice exercises.
